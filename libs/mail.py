...
class Connection(object):
    def __init__(self, host, port=25, user=None, passwd=None, silent=False):
        self.host = host
        self.port = port
        self.silent = silent
...
def test():
    email = Message('mengskysama@gmail.com',['123456798@qq.com'], 'subject')
    conn = Connection('smtp.gmail.com', 25 ,'mengskysama@gmail.com', 'passwd')
